...
suite =
    describe "Tokipona test suite"
        ...
        , describe
            ...
            , test "suno li lon sewi" <| \_ -> translateNimiPona "suno li lon sewi" |> equal "sun / to be in|at|on / high"
            ...
            , test "ona li lawa e jan tawa ma pona" <| \_ -> translateNimiPona "ona li lawa e jan tawa ma pona" |> equal "he, she, it / to lead / people / to|for / area / good"
            , test "ona li kama tawa ma mi" <| \_ -> translateNimiPona "ona li kama tawa ma mi" |> equal "he, she, it / going to / to go to / area / my"
            ...
            , test "mi lukin e ma. ni li pona tawa mi." <| \_ -> translateNimiPona "mi lukin e ma. ni li pona tawa mi." |> equal "I / to see / area. this, that / to be good / to|for / I."
            , test "ma li pona lukin" <| \_ -> translateNimiPona "ma li pona lukin" |> equal "area / to be beautiful"
